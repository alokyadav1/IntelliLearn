...
export default function ResetAllProgressDialog({ courseId }: { courseId: string }) {
  ...
  const modal = (
    ...
    >
      ...
      {/* Dialog panel */}
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 ring-1 ring-slate-900/5">
        {/* Icon */}
        ...
        {/* Content */}
        <h3 id="reset-dialog-title" className="text-[17px] font-bold text-slate-900 mb-1">
          Reset all progress?
        </h3>
        <p id="reset-dialog-desc" className="text-sm text-slate-500 leading-relaxed mb-6">
