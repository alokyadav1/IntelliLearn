...
export default function ModuleTopicSidebar({
    ...
    return (
        <aside className="w-72 shrink-0 border-r border-border bg-background/60 h-full flex flex-col overflow-hidden">
            {/* Header */}
            <div className="px-5 pt-6 pb-4 border-b border-border">
                ...
                <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-1">Current Module</p>
                        ...
                        <Link
                            ...
                            className={`group flex items-start gap-3 px-3 py-2.5 rounded-lg mb-1 transition-all text-sm border ${isActive
                                ...
                                : isCompleted
                                    ...
                                    : "text-muted-foreground border-transparent hover:bg-card hover:text-foreground hover:shadow-sm"
                                }`}
                        >
                            {/* Index or checkmark */}
                            <span className="shrink-0 mt-0.5 w-5 flex items-center justify-center">
                                {isCompleted ? (
                                    ...
                                    <span className={`text-xs font-mono ${isActive ? "font-bold opacity-100" : "text-muted-foreground/60"}`}>
                                        {index + 1}
                                    </span>
                                )}
                            </span>
            ...
            <div className="px-4 py-4 border-t border-border">
                <div className="bg-card rounded-lg border border-border px-3 py-2.5 shadow-sm">
