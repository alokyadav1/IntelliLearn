        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 animate-entry">
            ...
            <header className="mb-12">
                <div className="flex flex-wrap items-center gap-3 mb-6">
                    <div className="flex items-center space-x-2 text-sm text-sky-700 dark:text-sky-400 tracking-tight font-bold bg-sky-50 dark:bg-sky-950/30 px-3 py-1.5 rounded-lg w-fit border border-sky-100 dark:border-sky-900/30 transition-colors">
